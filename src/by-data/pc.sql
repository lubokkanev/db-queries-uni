...
-- 1.2
SELECT laptop.model, laptop.price * 1.1 AS 'Euro'
FROM laptop
ORDER BY 'Euro'
;

-- 1.3
SELECT laptop.model, laptop.hd, laptop.screen
FROM laptop
...
-- 1.6
SELECT laptop.code, laptop.model, laptop.speed + laptop.ram + 10 * laptop.screen AS 'Rating'
FROM laptop
